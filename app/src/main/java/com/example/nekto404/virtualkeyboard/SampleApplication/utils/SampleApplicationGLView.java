...
public class SampleApplicationGLView extends GLSurfaceView {
    ...
    public void init(boolean translucent, int depth, int stencil) {
        ...
        Timber.i("Using OpenGL ES 2.0");
        Timber.i("Using " + (translucent ? "translucent" : "opaque")
    ...
    private static class ContextFactory implements GLSurfaceView.EGLContextFactory {
        ...
        public EGLContext createContext(EGL10 egl, EGLDisplay display, EGLConfig eglConfig) {
            ...
            Timber.i("Creating OpenGL ES 2.0 context");
    ...
    private static void checkEglError(String prompt, EGL10 egl) {
        ...
        while ((error = egl.eglGetError()) != EGL10.EGL_SUCCESS) {
            Timber.e(String.format("%s: EGL error: 0x%x", prompt, error));
        }
    }
